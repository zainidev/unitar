...
public class BusinessLead extends BusinessEmployee{
    ...
    public boolean addReport(Accountant e, TechnicalLead supportTeam){
        ...
        //Should accept the reference to an Accountant object, and if the BusinessLead has head 
    	// count left should add this employee to their list of direct reports.
    ...
    public boolean approveBonus(Employee e, double bonus){
        ...
        // and if any of them are supporting a the TechnicalLead that is the manager of the 
    	// Employee passed in then the Accountant's budget should be consulted to see if the bonus could be afforded.
