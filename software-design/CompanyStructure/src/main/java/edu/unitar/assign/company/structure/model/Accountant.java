...
public class Accountant extends BusinessEmployee {
    ...
    public void supportTeam(TechnicalLead lead){
        ...
        // Once this happens the Accountant's bonus budget should be updated to be the total of each S
    	// oftwareEngineer's base salary that reports to that TechnicalLead plus 10%.
        // For example, if the TechnicalLead supports 2 SoftwareEngineers, each with a salary of 
