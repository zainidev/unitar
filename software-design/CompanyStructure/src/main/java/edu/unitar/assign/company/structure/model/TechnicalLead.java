...
public class TechnicalLead extends TechnicalEmployee {
    ...
    public boolean addReport(SoftwareEngineer e){
        ...
        if(hasHeadCount()){
        	...
        	// and if the TechnicalLead has head count left should add this employee to their list of direct reports.
            team.add(e);  
    ...
    public String getTeamStatus(){
        ...
        // It should return a string that is a combination of the TechnicalLead's employee status followed by 
        ...
        // If the TechnicalLead does have reports it might look something like "10 Kasey has 5 
